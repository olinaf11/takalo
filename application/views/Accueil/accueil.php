        ...
        <div class="container">
            <?php for ($i=0; $i<count($listObjet)/2;$i++){ ?>
                <div class="hero__slider owl-carousel">
                    <div class="hero__items set-bg" data-setbg="<?=base_url('')?>">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="hero__text">
                                    <div class="label"></div>
                                    <h2><?=$listObjet[$i]['nom']?></h2>
                                    <p></p>
                            ...
                            <div class="filter__gallery">
                                <div class="row">
                                    <?php foreach ($listObjet as $object){ ?>
                                        <div class="col-lg-4 col-md-6 cl-sm-8">
                                            <div class="product__item__pic set-bg mix <?=$object['nomCat']?>"
                                            data-setbg="img/sidebar/tv-1.jpg">
                                                <h5><a href="" style="cursor: auto; color: white" ><?=$object['nom']?></a></h5>
                                            </div>
