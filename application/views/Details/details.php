            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        <a href="<?php echo base_url('C_home')?>"><i class="fa fa-home"></i> Home</a>
                        <a href="<?php echo base_url('C_categorie')?>">Categories</a>
    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="anime__details__content">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg" data-setbg="<?php echo base_url('assets/img/#.jpg')?>">
                    ...
                    <div class="col-lg-9">
                        <div class="anime__details__text">
                            <div class="anime__details__title">
                                <h3> Land Cruiser Moteur V8</h3>
                                <span>Toyota: LC300</span>
                            </div>
